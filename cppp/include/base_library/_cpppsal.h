/**
 * @file include/base_library/_cpppsal.h
 * @author ChenPi11
 * @copyright Copyright (C) 2023
 * @date 2023-1-8
 * @language C
 * @brief C++ Plus MSVC SAL2 support
 * @see https://go.microsoft.com/fwlink/?LinkID=242134
 * @version 1.0.0.0
 */
#ifndef _CPPP_SAL_H_
#define _CPPP_SAL_H_

#if defined(_MSC_VER) && !defined(CPPP_NO_SAL)//Only MSVC
#include <sal.h>
