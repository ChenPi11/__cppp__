...
namespace _cpppbase
{
    namespace types
    {
        ...
        public:
            ...
            ~String() noexcept;
            _Ret_maybenull_ inline constexpr wchar_t* data() const noexcept;
            _Ret_z_ inline constexpr const wchar_t* c_str() const noexcept;
            inline constexpr size_t len() const noexcept;
            inline constexpr size_t length() const noexcept;
            inline constexpr size_t size() const noexcept;
            _CONSTEXPR20 std::wstring __str__() const noexcept;
